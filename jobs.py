    ...
    if enabled == 1:
        ...
        if channels_df.shape[0] > 0:
            ...
            if channels_df.shape[0] > 0:
                ...
                channels_df['adjusted_out_rate'] = channels_df.apply(lambda row: int(max(row['out_rate'],row['local_fee_rate'])*(1+row['net_routed_7day']*row['assisted_ratio']*multiplier/100)), axis=1)
