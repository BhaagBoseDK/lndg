    ...
    if enabled == 1:
        ...
        if channels_df.shape[0] > 0:
            ...
            if channels_df.shape[0] > 0:
                ...
                channels_df['new_rate'] = channels_df.apply(lambda row: row['local_fee_rate']*(1-0.021) if row['adjustment']==0 and row['out_percent']>=down_level and row['net_routed_7day']==0 else row['new_rate'], axis=1)
